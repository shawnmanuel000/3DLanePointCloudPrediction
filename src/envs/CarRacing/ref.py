...
try: 
	from src.envs.CarRacing.dynamics import CarState, DELTA_T, TURN_SCALE, PEDAL_SCALE
	from src.envs.CarRacing.track import track_name
except ImportError as e: 
	from track import track_name
	from dynamics import CarState, DELTA_T, TURN_SCALE, PEDAL_SCALE
...
refs = {"sebring":"GT3data_cTire"}
loaded_refs = {}
loaded_point_maps = {}

class RefDriver():
	def __init__(self, track_name=track_name, dt=0.01):
		self.ref_name = refs.get(track_name, track_name)
