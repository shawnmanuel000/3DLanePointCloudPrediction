...
env_agent_configs = {
	...
	env_grps["car"]: {
		"mppi": Config(
			...
			ENV_MODEL = "batchreal",
			MPC = Config(
				NSAMPLES = 200, 			# The number of sample trajectories to rollout when calculating the control update
				HORIZON = 150,  			# How many time steps into the future to rollout each trajectory sample
